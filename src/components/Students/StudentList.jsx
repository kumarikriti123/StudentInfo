...
function StudentList() {
  ...
  return (
    <div className="student-list-container overflow-x-auto relative top-[15vh]  ">
      <div
        style={{
          marginLeft: "2vw",
      ...
      >
        ...
        <div className="pt-4 sm:pt-16 lg:pt-3"> 
          <div className="overflow-x-auto overflow-y-auto max-h-[calc(100vh-100px)]">
            <table className="w-full bg-gradient-to-r from-gray-300 to-gray-200 mx-auto">
              <thead>
              ...
              <tbody>
                {filteredStudents.length > 0 ? (
                  filteredStudents.map((student, index) => (
                    <tr key={student.id} className="text-black border-b border-gray-400 last:border-b-0">

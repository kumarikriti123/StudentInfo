...
function StudentProfile() {
  ...
  <div className="bg-gradient-to-r from-gray-200 to-gray-300 p-6 rounded-lg lg:flex flex-row items-center shadow-lg shadow-black ">
    <img 
...
<div className="w-full max-w-full mx-auto mt-8 p-5 rounded-lg shadow-lg shadow-black border-2 border-gray-500 bg-gradient-to-r from-gray-200 to-gray-300">
  ...
  <div className="mb-3 mt-1">
    ...
    <div
      className={`mt-2 pl-6 pr-4 py-2 text-black text-base font-medium bg-gray-200 border border-gray-300 rounded-lg transition-all ease-in-out duration-300 ${
...
<div className='text-center bg-gradient-to-r from-gray-200 to-gray-300 mt-7 text-base text-black rounded-md border border-gray-500 p-3 w-[330px] lg:w-full md:w-full mb-8'>
  <div className='text-red-900 font-medium text-xl py-2'>
  ATTENDENCE
  </div>
  
    <div className='md:flex justify-between' >
    <div className='px-1 md:block flex justify-between'>
     <div className=''>TOTAL CLASS</div> 
      <div className='mr-5'>120</div>
    </div>
    <div className='px-1 md:block flex justify-between'>
      <div>ABSENT</div>
      <div className='mr-5'>

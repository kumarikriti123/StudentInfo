...
const Home = () => {
  return (
    <div className="font-sans bg-gray-50 relative top-[15vh]">
      ...
      <section id="features" className="py-10 justify-center">
        <div className="max-w-screen-xl mx-auto px-6">
          <h2 className="text-3xl font-semibold text-red-800">Course Features</h2>
          <div className="mt-8 grid gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3">
  ...
  <div className="flex flex-wrap justify-center gap-8 sm:gap-12 xl:gap-12">
    <div className="bg-white text-center p-14 rounded-xl shadow-2xl max-w-full sm:max-w-lg md:max-w-lg lg:max-w-md xl:max-w-lg w-full">
      <h1 className="text-3xl sm:text-4xl md:text-4xl font-extrabold text-red-900 mb-6 leading-tight tracking-tight">
